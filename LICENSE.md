...
1. **Include LICENSE**: Ensure the full `Qarvexium SOFTWARE LICENSE AGREEMENT (2025)` is bundled with any distributed artifact (binary, container image, package).
...
4. **Manifest Flag**: Add a machine-readable flag in package manifests (e.g., `license_attached: true` and `Qarvexium_license_version: "2025"`).
